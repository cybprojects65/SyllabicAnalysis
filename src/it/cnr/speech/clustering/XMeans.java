...
public class XMeans 
   ...
   */
  public XMeans(HashMap<String,String> labels) {
    super();
  ...
  public void compute(int minpoints, int minClusters, int maxClusters, int maxIterations, double[][]data, File outputFile) throws Exception{
